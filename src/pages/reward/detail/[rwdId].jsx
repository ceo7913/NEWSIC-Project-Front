  ...
  return (
    <div className='fundingDetailFrame'>
        ...
        <div className='fundingInfoSection' ref={infoSlideFrameRef}>
          ...
          >
            <img src={leeImg} alt="fundingImg" className='fundingImg'/>
            ...
            {/* {right:0,left:-510} */}
              <motion.div className='infoList' drag="x" dragConstraints={{right:0,left:-1300}}>
                  ...
                  >
                    ...
                    <div className='innerText'>the 1500s, when an unknown printer took a galleymbled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.mbled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, </div>
                  </motion.div>
                  <motion.div className='infoItemBox'
                    initial={{x:"100vh",opacity:0}}
                    animate={{x:0,opacity:1}}
