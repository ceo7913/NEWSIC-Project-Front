...
import image1 from "../../image/IRON.jpg";
import image2 from "../../image/dddepth-343.jpg";
      ...
      <div className="nftSellSection">
        ...
        <div className="sellMiddle">
          <div className="nftItemList">
            {data.map((item, index) => (
              <div key={index} className="nftItemBox" onClick={toNftDetail}>
                ...
                >
                  <img className="bottomImage" src={item.funding_nft_image} alt={""}  />
